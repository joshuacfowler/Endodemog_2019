...
\begin{itemize}
\item{\textbf{Stochastic demography:} Incorporate model vectorization for the flowering and survival models and/or figure out if that is just not worth it. Add mixture model for the zero inflated distribution in the growth model.}

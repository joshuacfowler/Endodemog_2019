...
This meeting was a little bit shorter than normal due to rescheduling, but we talked generally about the questions for my projects and set some goals for our next meeting on Wednesday. The goals are related to those that I set in the previous meeting, but are much more specific.

\textbf{Those goals include:}
\begin{itemize}
\item{Have model results from surv, growth, and flowering models.}
\item{Have annotated bibliography for endophyte range surveys and herbarium research.}
\item{Come with a 2nd draft of more defined research questions.}
\end{itemize}
